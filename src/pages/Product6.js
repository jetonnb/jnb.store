...
const Product6 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 18.99,
      image:
        'https://bigstar-ks.com/wp-content/uploads/2022/05/image00024-1-scaled.jpeg', // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      <div style={imageContainerStyle}>
        <img
          src="https://bigstar-ks.com/wp-content/uploads/2022/05/image00024-1-scaled.jpeg"
          alt="Product 6"
          style={imageStyle}
        />
      </div>
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 6 Details</h1>
        <p style={priceStyle}>Price: $18.99</p>
