...
const Product2 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 29.99,
      image:
        'https://bigstar-ks.com/wp-content/uploads/2022/05/image00006-3-scaled.jpeg', // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 2 Details</h1>
        <p style={priceStyle}>Price: $29.99</p>
