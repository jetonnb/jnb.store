...
const Product7 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 21.99,
      image:
        'https://bigstar-ks.com/wp-content/uploads/2022/04/image00026-1-scaled.jpeg', // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      <div style={imageContainerStyle}>
        <img
          src="https://bigstar-ks.com/wp-content/uploads/2022/04/image00026-1-scaled.jpeg"
          alt="Product 7"
          style={imageStyle}
        />
      </div>
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 7 Details</h1>
        <p style={priceStyle}>Price: $21.99</p>
