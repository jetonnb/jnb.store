...
const Product1 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 19.99,
      image:
        'https://bigstar-ks.com/wp-content/uploads/2022/06/image00015-scaled.jpeg', // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 1 Details</h1>
        <p style={priceStyle}>Price: $19.99</p>
