...
const Product1 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 19.99,
      image:
        "https://bigstar-ks.com/wp-content/uploads/2022/06/image00015-scaled.jpeg",
    });
  };

  return (
    <div style={isMobile ? containerStyleMobile : containerStyleDesktop}>
      <div
        style={
          isMobile ? imageContainerStyleMobile : imageContainerStyleDesktop
        }
      >
        <img
          src="https://bigstar-ks.com/wp-content/uploads/2022/06/image00015-scaled.jpeg"
          alt="Product 1"
          style={isMobile ? imageStyleMobile : imageStyleDesktop}
        />
      </div>
      <div
        style={isMobile ? textContainerStyleMobile : textContainerStyleDesktop}
      >
        <h1 style={isMobile ? titleStyleMobile : titleStyleDesktop}>
          Product 1 Details
        </h1>
        <p style={isMobile ? priceStyleMobile : priceStyleDesktop}>
          Price: $19.99
        </p>
        <div
          style={
            isMobile ? sizeContainerStyleMobile : sizeContainerStyleDesktop
          }
        >
