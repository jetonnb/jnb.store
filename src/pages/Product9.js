...
const Product9 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 15.99,
      image:
        'https://bigstar-ks.com/wp-content/uploads/2022/03/image00012-3-scaled.jpeg', // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      <div style={imageContainerStyle}>
        <img
          src="https://bigstar-ks.com/wp-content/uploads/2022/03/image00012-3-scaled.jpeg"
          alt="Product 9"
          style={imageStyle}
        />
      </div>
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 9 Details</h1>
        <p style={priceStyle}>Price: $15.99</p>
