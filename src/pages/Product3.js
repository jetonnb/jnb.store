...
const Product3 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      price: 16.99,
      image:
        'https://bigstar-ks.com/wp-content/uploads/2022/05/image00014-scaled.jpeg', // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      <div style={imageContainerStyle}>
        <img
          src="https://bigstar-ks.com/wp-content/uploads/2022/05/image00014-scaled.jpeg"
          alt="Product 3"
          style={imageStyle}
        />
      </div>
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 3 Details</h1>
        <p style={priceStyle}>Price: $16.99</p>
