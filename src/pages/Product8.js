...
const Product8 = () => {
  ...
  const handleAddToCart = () => {
    ...
    addToCart({
      ...
      size: selectedSize,
      price: 17.99,
      image: "https://bigstar-ks.com/wp-content/uploads/2022/05/1-2.jpeg", // Include the image URL
    });
  };
  ...
  return (
    <div style={containerStyle}>
      <div style={imageContainerStyle}>
        <img
          src="https://bigstar-ks.com/wp-content/uploads/2022/05/1-2.jpeg"
          alt="Product 8"
          style={imageStyle}
        />
      </div>
      <div style={textContainerStyle}>
        <h1 style={titleStyle}>Product 8 Details</h1>
        <p style={priceStyle}>Price: $17.99</p>
        <div style={sizeContainerStyle}>
          ...
          <button
            style={
              selectedSize === "XL" ? selectedButtonStyle : sizeButtonStyle
            }
            onClick={() => {
              handleSizeSelect("XL");
            }}
